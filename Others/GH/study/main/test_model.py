...
class KoBERT:
    def __init__(self):
        ...
        self.model_state_dict = torch.load("C:\\Users\\Yun\\Attention\\ARS-system-for-protecting-telephone-counselor\\GH\\study\\main\\kobert_classifier.pth", map_location=self.device)

...
class KoBERT:
    def __init__(self):
        ...
        self.model_state_dict = torch.load("C:\\Users\\User\\DataspellProjects\\ARS-system-for-protecting-telephone-counselor\\SH\\study\\main\\kobert_classifier.pth", map_location=self.device)
